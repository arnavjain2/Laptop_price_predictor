...
df1 = pickle.load(open(r'C:\Users\arnav\OneDrive\Desktop\Laptop_price_predictor\laptop price predictor\xgboost.pkl', 'rb'))
print(df1)
bg = ImageTk.PhotoImage(Image.open("back.jpg").resize((650,700), Image.Resampling.LANCZOS))
...
img = ImageTk.PhotoImage(Image.open("download.jpeg").resize((35,50), Image.Resampling.LANCZOS))
